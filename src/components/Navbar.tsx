...
const navigation = [
  { name: 'news', href: '/nyheter', icon: NewspaperIcon },
  { name: 'about', href: '/om-rockaden', icon: InformationCircleIcon },
  { name: 'training', href: '#', icon: AcademicCapIcon },
  { name: 'play', href: '#', icon: PuzzlePieceIcon },
];
      ...
      <div className="px-1 mx-auto max-w-full py-2">
        <div className="flex justify-between h-12">
          ...
          <div className="flex items-center flex-shrink-0 pl-1">
            ...
            >
              <span className="block">SK</span>
              <span className="block">Rockaden</span>
            </Link>
          </div>

          {/* Navigation Icons and Controls */}
          <div className="flex items-center pr-1">
            ...
            <div className="relative ml-2 hidden md:block">
              <IconButton
                ...
                size="large"
                title={`${languages.find((l) => l.code === language)?.flag} ${language.toUpperCase()}`}
                className="text-gray-600 dark:text-gray-400 bg-transparent hover:bg-gray-100 dark:hover:bg-gray-800"
              />
              <div
